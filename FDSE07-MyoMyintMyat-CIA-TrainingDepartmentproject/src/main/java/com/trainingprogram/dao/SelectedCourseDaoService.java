...
public class SelectedCourseDaoService implements SelectedCourseDao {
	...
	public List<Course> getAllCourses() {
		...
		return ReadSheetUtils.ReadCourse("C:\\Users\\USER\\eclipse-lithan-CSM-workspace\\FDSE07-MyoMyintMyat-CIA-TrainingDepartmentproject\\src\\main\\webapp\\CIA.xlsx"); // calling excel sheet Path..
	}

	@Override
	public List<String> getAllTime() {

		return ReadSheetUtils.ReadTime("C:\\Users\\USER\\eclipse-lithan-CSM-workspace\\FDSE07-MyoMyintMyat-CIA-TrainingDepartmentproject\\src\\main\\webapp\\CIA.xlsx");
