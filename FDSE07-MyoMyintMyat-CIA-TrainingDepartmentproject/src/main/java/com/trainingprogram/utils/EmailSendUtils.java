...
public class EmailSendUtils {
	...
	public void SendEmail(CourseRegister userInfo) {
		...
		final String username = "kairi31myomyat@gmail.com";
		final String password = "jmca aaoc seyb ihhb"; // app code copy and past here
		...
		try {
			...
			message.setFrom(new InternetAddress("kairi31myomyat@gmail.com"));
